...
function selectTitle(href) {
	document.getElementById('search').action = "${uri}/admin/mail-share?href="+href; 
}
</script>
</head>
...
<body>
				...
				<div class="content-wrapper">
						...
						<div class="col-12 grid-margin">
							<div class="card">
								<div class="card-body">
									...
									<form id="search" action="${uri}/admin/mail-share"
					...
					<div class="row" id="result" style="display: none;">
							...
							<div class="card" style="height: 100%;">
								<div class="card-body">
									...
									<div style="display: flex;">
										<div class="col-4 avatar-upload" style="max-width: 320px; margin: 0 auto">
										...
										<div class="col-8 d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 mt-1" >
											<div class="text-md-center text-xl-left">
												<h4 id="title" class="mb-3" style="color: #515151; font-weight: bold">${video.title}</h4>
												<p class="text-muted mb-0" id="name" style="color: #515151 !important; font-size: 15px"><b class="mr-2">Href:</b> ${video.href}</p>
												<p class="text-muted mb-0" id="name" style="color: #515151 !important; font-size: 15px"><b class="mr-2">View:</b> ${video.views}</p>
												<p class="text-muted mb-0" id="name" style="color: #515151 !important; font-size: 15px"><b class="mr-2">Date release:</b> ${video.dateUpload}</p>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-12 grid-margin">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">List User Shared This Video</h4>
									...
									<div class="">
										<table class="table" style="table-layout: fixed">
											...
											<tbody>
												...
												<c:forEach var="share" items="${video.shares}">
													<c:set var="stt" value="${stt + 1}" />
													<tr>
														<td>${stt}</td>
														<td><img
															src="../templates/images/auth/${share.userS.username}.jpg"
															alt="" /> <span class="pl-2">${share.userS.fullname}</span></td>
														<td>${share.userS.email}</td>
														<td>${share.email}</td>
	...
	<script>
		...
		function selectNum(num,check) {
			if(check == "prev" && num > 1){
				document.getElementById('page').action = "${uri}/admin/mail-share?page="+(num-1);
			}else if(check == "next" && num < parseInt("${page}")){
				document.getElementById('page').action = "${uri}/admin/mail-share?page="+(num+1);
			}else document.getElementById('page').action = "${uri}/admin/mail-share?page="+num;
